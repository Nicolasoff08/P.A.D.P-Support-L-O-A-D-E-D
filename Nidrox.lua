...
--// variables etc
    ...
    local LoaderTitle = "nidroxpadp.uwu revamped"
    ...
    AcceptButton.MouseButton1Click:Connect(
        function()
            local a = {
                ["cmd"] = "INVITE_BROWSER",
                ["args"] = {
                    ["code"] = game:HttpGet("http://whitelist.nidroxpadp.uwu/getDiscordCode")
                },
...
do
	...
	local IMGUIWindow = library:AddWindow("nidroxpadp.uwu v2", {
	...
	do
		...
		anotherTab:AddLabel("Nidrox#8425")
		anotherTab:AddLabel("UI = .gg/conavihood")
		anotherTab:AddLabel("Nidrox#8425")
